...
import com.example.semesc.halda.AbstrHeapImplNew;
import com.example.semesc.model.Gps;
import com.example.semesc.model.Pamatky;
import com.example.semesc.model.Zamek;
...
import static com.example.semesc.enums.eTypKey.GPS;
...
public class Controller implements Initializable {
    ...
    private final AbstrHeapImplNew<Zamek> abstrHeapI = new AbstrHeapImplNew<>();
    ...
    void btnNajdiHaldaOA(ActionEvent event) {
        ...
        Zamek hledanyZamek = new Zamek(999, "Hledany", new Gps(Double.parseDouble(data[0]), Double.parseDouble(data[1])));
        this.abstrHeapI.setHledany(hledanyZamek);
        ...
        this.listViewHalda.getSelectionModel().select(this.abstrHeapI.zprusupniMax());
    ...
    @FXML
    void btnZprisMaxOA(ActionEvent event) {
        this.listView.getSelectionModel().select(this.abstrHeapI.zprusupniMax());
        this.listViewHalda.getSelectionModel().select(this.abstrHeapI.zprusupniMax());
    }
